 ...
 */
public class AddTheLoaiRuou extends javax.swing.JFrame {
    private ArrayList<TheLoai> dsTl;
    BaoTriTheLoaiRuou bt;
            
    /**
     * Creates new form AddTheLoaiRuou
     */
    public AddTheLoaiRuou() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tentl = jTextField2.getText();
        
        bt = new BaoTriTheLoaiRuou(matl, tentl);
        bt.setVisible(true);
        this.dispose();
